...
const REDIRECT_URI = process.env.NEXTAUTH_URL ? `${process.env.NEXTAUTH_URL}/api/auth/social/microsoft/callback` : 'https://www.optionforbeginner.com/api/auth/social/microsoft/callback';
