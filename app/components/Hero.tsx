...
export function Hero() {
  ...
  return (
    <section 
      ref={container}
      className="relative min-h-[90vh] sm:min-h-screen pt-20 pb-12 sm:pt-24 sm:pb-16 md:py-32 flex items-center justify-center overflow-hidden bg-[#050714]"
    >
      ...
      <div className="container relative z-20 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12 px-4 sm:px-6">
        <div className="hero-content w-full md:max-w-2xl space-y-4 sm:space-y-6 md:space-y-8 text-center md:text-left">
          <div className="inline-block px-3 sm:px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-500 text-xs font-medium tracking-wider mb-1 sm:mb-2">
            INDIAN MARKET INTELLIGENCE
          </div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white font-montserrat">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-400 leading-relaxed max-w-xl mx-auto md:mx-0">
          ...
          <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-3 sm:gap-4 pt-2 sm:pt-4">
            {!isAuthenticated ? (
              <Link href="/sign-up" className="w-full sm:w-auto">
                <Button size="lg" className="bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white shadow-lg shadow-orange-500/20 border-none text-sm sm:text-base px-6 sm:px-8 py-4 sm:py-5 w-full">
                  Start Free Trial
                </Button>
              </Link>
            ) : (
            ...
            <Button size="lg" variant="outline" className="border-orange-500/30 text-orange-400 hover:bg-orange-500/10 hover:text-orange-300 text-sm sm:text-base px-6 sm:px-8 py-4 sm:py-5 w-full sm:w-auto">
              Learn More
            </Button>
          </div>
