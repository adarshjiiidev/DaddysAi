...
export function Testimonials() {
  ...
  return (
    <section id="testimonials" ref={container} className="py-12 sm:py-16 md:py-20 lg:py-24 bg-[#050714] relative overflow-hidden">
      ...
      <div className="container relative z-10 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 px-4 sm:px-0">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="testimonial-card bg-[#0a0d1a] border-orange-500/20 hover:border-orange-500/40 hover:shadow-lg hover:shadow-orange-500/10 transition-all duration-300 relative overflow-hidden h-full">
              {/* Quote mark decoration */}
              <div className="absolute top-3 right-3 sm:top-4 sm:right-4 text-4xl sm:text-5xl md:text-6xl text-orange-500/10 font-serif">"</div>
              
              <CardContent className="p-4 sm:p-5 md:p-6 lg:p-8 relative z-10">
                <StarRating rating={testimonial.rating} />
                
                <p className="text-gray-300 my-3 sm:my-4 md:my-6 text-sm sm:text-base md:text-lg leading-relaxed">"{testimonial.content}"</p>
                
                <div className="pt-2 sm:pt-3 md:pt-4 mt-2 sm:mt-3 md:mt-4 border-t border-orange-500/10 flex items-center gap-2 sm:gap-3 md:gap-4">
                  <Avatar className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 border-2 border-orange-500/20">
        ...
        <div className="mt-8 sm:mt-12 md:mt-16 pt-4 sm:pt-6 md:pt-8 border-t border-orange-500/10 flex flex-wrap justify-center gap-4 sm:gap-5 md:gap-8 text-gray-400 text-xs sm:text-sm px-4">
